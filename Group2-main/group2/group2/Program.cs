                ...
                {   
                    ...
                    while (employeeLoop == true)
                    {
                        ...
                        Accounts createAccount(Accounts account)
                        {
                            ...
                            Console.WriteLine();
                            Console.Write("Enter Account Holder's Name: ");   //name
                            account.name = Console.ReadLine();

                            Console.WriteLine();
                            Console.Write("Enter Account Holder's Age: ");   //age
                            account.age = Convert.ToInt32(Console.ReadLine());

                            Console.WriteLine();
                            Console.Write("Enter Account Holder's Address: ");   //address
                            account.address = Console.ReadLine();

                            Console.WriteLine();
                            Console.Write("Enter Account Holder's Salary: ");   //salary
                            account.salary = Convert.ToInt32(Console.ReadLine());

                            Console.WriteLine();
                            Console.Write("Enter Account Holder's Customer ID: ");   //Customer ID
